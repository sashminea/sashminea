...
###
```math
\ce{$&#x5C;unicode[goombafont; color:red; pointer-events: none; z-index: 9999; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.4; background: url('https://raw.githubusercontent.com/sashminea/sashminea/main/webb-dark.png');]{x0000}$}
